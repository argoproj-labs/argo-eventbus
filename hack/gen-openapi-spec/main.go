...
import (
	...
	ebv1 "github.com/argoproj-labs/argo-eventbus/pkg/apis/v1alpha1"
)
...
// e.g.:
// github.com/argoproj-labs/argo-eventbus/pkg/apis/v1alpha1.EventBus
// to:
// io.argoproj.v1alpha1.EventBus
func swaggify(name string) string {
	name = strings.ReplaceAll(name, "github.com/argoproj-labs/argo-eventbus/pkg/apis", "argoproj.io")
